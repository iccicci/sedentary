...
describe("class Sedentary - errors", () => {
  ...
  describe("Sedentary.model(name) - invalid (starts with digit)", () =>
    errorHelper(db => db.model("1test", {}))("Sedentary.model: '1test' model: Invalid model name, expected ASCII letters, digits or underscore, cannot start with digit"));
  ...
  describe("Sedentary.model(, { [key] }) - reserved (load)", () => errorHelper(db => db.model("test", { load: {} as never }))("Sedentary.model: 'test' model: 'load' attribute: Reserved name"));
  describe("Sedentary.model(, { [key] }) - reserved (remove)", () => errorHelper(db => db.model("test", { remove: {} as never }))("Sedentary.model: 'test' model: 'remove' attribute: Reserved name"));
  ...
  describe("Sedentary.model(, { [key]: defaultValue }) - number", () =>
    errorHelper(db => db.model("test", { test: db.Int({ defaultValue: "23" as never }) }))("Sedentary.model: 'test' model: 'test' attribute: 'defaultValue' option: Wrong type, expected 'number'"));
  describe("Sedentary.model(, { [key]: defaultValue }) - string", () =>
    errorHelper(db => db.model("test", { test: db.VarChar({ defaultValue: 23 as never }) }))("Sedentary.model: 'test' model: 'test' attribute: 'defaultValue' option: Wrong type, expected 'string'"));
  describe("Sedentary.model(, { [key]: defaultValue }) - string", () =>
    errorHelper(db => db.model("test", { test: db.Int8({ defaultValue: 23 as never }) }))("Sedentary.model: 'test' model: 'test' attribute: 'defaultValue' option: Wrong type, expected 'BigInt'"));
  describe("Sedentary.model(, { [key]: defaultValue }) - Date", () =>
    errorHelper(db => db.model("test", { test: db.DateTime({ defaultValue: 23 as never }) }))("Sedentary.model: 'test' model: 'test' attribute: 'defaultValue' option: Wrong type, expected 'Date'"));
  ...
  describe("Sedentary.FKey() - unique", () =>
    errorHelper(db => {
