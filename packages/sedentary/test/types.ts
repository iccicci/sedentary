...
import { Entry, EntryBase, OrderBy, Type, Where } from "..";
...
const t1 = new T1();
expectAssignable<Type<number, true, EntryBase>>(T1);
expectNotAssignable<Type<string, true, EntryBase>>(T1);
expectType<T1>(t1);
...
const t2 = new T2();
expectAssignable<Type<number, true, EntryBase>>(T2);
expectNotAssignable<Type<string, true, EntryBase>>(T2);
expectType<T2>(t2);
...
const t3 = new T3();
expectAssignable<Type<number, true, EntryBase>>(T3);
expectNotAssignable<Type<string, true, EntryBase>>(T3);
expectType<T3>(t3);
...
const T4 = db.model(
  ...
  {
    a: db.Int(),
    b: db.VarChar({ size: 10 }),
    c: db.Int({ notNull: true }),
    d: db.VarChar({ notNull: true, size: 10 }),
    e: db.VarChar<"foo" | "bar">(),
    f: db.Float(),
    g: db.VarChar<"foo" | "bar">({ notNull: true, size: 10 }),
    h: db.Boolean(),
    i: db.Boolean({ notNull: true })
  },
  {},
  {
...
expectAssignable<Type<number, true, EntryBase>>(T4);
expectNotAssignable<Type<string, true, EntryBase>>(T4);
expectType<T4>(t4);
...
expectType<
  EntryBase & { a: number | null; b: string | null; c: number; d: string; e: "foo" | "bar" | null; f: number | null; g: "foo" | "bar"; h: boolean | null; i: boolean; id: number } & {
    m: (a: number) => string;
    n: (a: number) => number;
      }
      >(t4);
...
const t5 = new T5();
expectAssignable<Type<string, true, EntryBase>>(T5);
expectNotAssignable<Type<number, true, EntryBase>>(T5);
expectType<T5>(t5);
...
expectAssignable<Type<Date | null, true, EntryBase>>(T6);
expectNotAssignable<Type<number, true, EntryBase>>(T6);
expectNotAssignable<Type<string, true, EntryBase>>(T6);
expectType<T6>(t6);
...
const t7 = new T7();
expectAssignable<Type<number, true, EntryBase>>(T7);
expectNotAssignable<Type<string, true, EntryBase>>(T7);
expectType<T7>(t7);
...
const t8 = new T8();
expectAssignable<Type<Date | null, true, EntryBase>>(T8);
expectNotAssignable<Type<string, true, EntryBase>>(T8);
expectType<T8>(t8);
...
expectAssignable<Type<Date | null, true, EntryBase>>(T9);
expectNotAssignable<Type<string, true, EntryBase>>(T9);
expectType<T9>(t9);
...
const t10 = new T10();
expectAssignable<Type<Date | null, true, EntryBase>>(T10);
expectNotAssignable<Type<string, true, EntryBase>>(T10);
expectType<T10>(t10);
...
const t11 = new T11();
expectAssignable<Type<Date | null, true, EntryBase>>(T11);
expectNotAssignable<Type<string, true, EntryBase>>(T11);
expectType<T11>(t11);
...
const t12 = new T12();
expectAssignable<Type<number, true, EntryBase>>(T12);
expectNotAssignable<Type<string, true, EntryBase>>(T12);
expectType<T12>(t12);
expectType<number | null>(t12.a);
expectType<string | null>(t12.b);
expectType<number>(t12.c);
expectType<string>(t12.d);
expectType<Date | null>(t12.z);
expectType<
  EntryBase & { a: number | null; b: string | null; c: number; d: string; e: "foo" | "bar" | null; f: number | null; g: "foo" | "bar"; h: boolean | null; i: boolean; z: Date | null; id: number } & {
    m: (a: number) => string;
    n: (a: number) => number;
      } & {
    o: (a?: Date) => void;
...
expectAssignable<Partial<T12>>({ a: 0, b: "", c: 0, d: "", z: new Date() });
...
const t13 = new T13();
expectAssignable<Type<number, true, EntryBase>>(T13);
expectNotAssignable<Type<string, true, EntryBase>>(T13);
expectType<T13>(t13);
...
const t15 = new T15();
expectAssignable<Type<number, true, EntryBase>>(T15);
expectNotAssignable<Type<string, true, EntryBase>>(T15);
expectType<T15>(t15);
expectType<EntryBase & { a: unknown; b: t15_1 | null; c: t15_1 | null; d: t15_1; id: number }>(t15);
type t15_2 = typeof T15 extends new (from: infer T) => EntryBase ? Exclude<T, undefined> : never;
expectType<{ a?: unknown; b?: t15_1 | null; c?: t15_1 | null; d?: t15_1; id?: number }>({} as t15_2);
